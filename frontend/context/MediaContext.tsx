...
//below almost work, but wasPlayingOnHomepage not indicate the right thing
...
//       setIsPlaying(false);
//       if (isHomePage()) {
//         sessionStorage.setItem("wasPlaying", "false"); // Set playing state to false only if on the homepage
//       }
//     }
//   };
...
//       setCurrentSong(null);
//       if (isHomePage()) {
//         sessionStorage.setItem("wasPlaying", "false"); // Update wasPlaying to false only if on the homepage
//       }
//     }
//   };
