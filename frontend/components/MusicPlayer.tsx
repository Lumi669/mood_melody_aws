...
//   useEffect(() => {
//     // Retrieve the last played song for each mood from localStorage when the component mounts
//     const mood = localStorage.getItem("currentMood");
//     if (mood) {
//       const lastPlayedSong = localStorage.getItem(`lastPlayed_${mood}`);
//       if (lastPlayedSong) {
//         const song = JSON.parse(lastPlayedSong);
//         setCurrentSong(song); // Set the last played song
//         playTrack(song.url, song); // Play the last played song
//       }
//     }
//   }, []);
