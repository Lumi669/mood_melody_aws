  ...
  return (
    <div className="h-screen overflow-y-scroll p-4 pb-40">
      ...
      <p className="text-gray-700 mb-4">
        This Privacy Policy explains how this app handles your data. Please note
        that this app is a demonstration project created to showcase my
      ...
      <p className="text-gray-700 mb-4">
        All content is used for demonstration purposes only and is not intended
      ...
      <ul className="list-disc pl-6 mb-4">
        ...
        <li>
          <strong>Usage Data:</strong> The app may track how users navigate and
          use the app to demonstrate usage statistics.
        </li>
        <li>
      ...
      <p className="text-gray-700 mb-4">
        The app employs standard security measures to protect data. However, as
        this is a demo app, it is not intended to handle sensitive or personal
        information.
      </p>

      <h2 className="text-xl font-semibold mb-2">User Rights</h2>
      <p className="text-gray-700 mb-4">
        Since this is a demonstration app, no real data is collected, stored, or
        processed. As such, users do not have personal data rights to request
