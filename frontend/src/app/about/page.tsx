        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              className="border-2 border-red-500 bg-yellow-100 text-black px-6 py-3 rounded-full shadow-md hover:bg-yellow-200 hover:shadow-lg active:bg-yellow-300 active:shadow-none focus:outline-none focus:ring-4 focus:ring-yellow-100 transition-all duration-200 ease-in-out flex items-center group"
            >
              Contact me
